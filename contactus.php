...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Call to schedule a tour and learn more about the senior living services offered by Sunshine Gardens Assisted Living, Marion.">
   ...
   <!--  <link rel="icon" href="../../favicon.ico"> -->
    <!-- Global site tag (gtag.js) - Google Analytics -->
	  ...
	  <!-- Global site tag (gtag.js) - Google Ads: 667373387 -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=AW-667373387"></script>
			<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

  				gtag('config', 'AW-667373387');
			</script>
<!--------End of Script --------->
...
if(isset($_POST['submit'])){ 
    ...
    if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['message'])){ 
        ...
        if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){ 
            ...
            $secretKey = '6LfqovwUAAAAAEnPF7fahO7DWHyyVxmhcMqYFT_y'; 
            ...
            if($responseData->success){ 
                // Posted form data 
            $from="sunshinegardensmarion@gmail.com";
         	$to="medsite2002@yahoo.com";
         	$subject="new message";
            ...
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
             ...
             $statusMsg="Thank you for contacting us, we will respond soon.";		
         	}
         	else {
         		$statusMsg= "Please try again in some time.";
         	}
                $postData = '';
            }else{ 
            ...
            $statusMsg = 'Please check the checkbox.'; 
        } 
    }else{ 
        $statusMsg = 'Please complete all the fields.'; 
    } 
} 
?>
  ...
  <form  method="post" id="email-form" name="email-form" data-name="Email Form" enctype="multipart/form-data">
	...
	<br>
	<br>
	<p style="color:red"><b><?php echo $statusMsg ?></b></p>
  </form>
</div>
    ...
    <div class="row contactSec">
	  ...
	  <div style="overflow: hidden;">
        <p style="float:left;">Copyright &copy; 2020 Sunshine Gardens</p>
		<p style="float:right;color:black;" align="right"><a id="sitemap" href="sitemap.html" ><b style="color:black;">Sitemap</b></a></p>
		</div>
      </footer>
	  </div>
